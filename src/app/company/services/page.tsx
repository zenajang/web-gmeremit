          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-16 flex items-center justify-between">
              ...
              <div className="hidden lg:flex items-center gap-3 relative">
                ...
                <div
                  className="w-16 h-16 rounded-3xl bg-[#ed1c24] flex items-center justify-center p-3 shadow-[0_20px_40px_-10px_rgba(237,28,36,0.5)] hover:shadow-[0_25px_50px_-10px_rgba(237,28,36,0.6)] transition-all duration-300"
                ...
                {/* G - Blue */}
                <div
                  className="w-16 h-16 rounded-3xl bg-[#3b82f6] flex items-center justify-center shadow-[0_20px_40px_-10px_rgba(59,130,246,0.5)] hover:shadow-[0_25px_50px_-10px_rgba(59,130,246,0.6)] transition-all duration-300"
                  style={{ animation: 'wave 2s ease-in-out infinite 0.2s' }}
                >
                  <span className="text-white text-3xl font-black">G</span>
                </div>
                {/* M - Yellow */}
                <div
                  className="w-16 h-16 rounded-3xl bg-[#f59e0b] flex items-center justify-center shadow-[0_20px_40px_-10px_rgba(245,158,11,0.5)] hover:shadow-[0_25px_50px_-10px_rgba(245,158,11,0.6)] transition-all duration-300"
                  style={{ animation: 'wave 2s ease-in-out infinite 0.4s' }}
                >
                  <span className="text-white text-3xl font-black">M</span>
                </div>
                {/* E - Black */}
                <div
                  className="w-16 h-16 rounded-3xl bg-[#1f2937] flex items-center justify-center shadow-[0_20px_40px_-10px_rgba(31,41,55,0.6)] hover:shadow-[0_25px_50px_-10px_rgba(31,41,55,0.7)] transition-all duration-300"
                  style={{ animation: 'wave 2s ease-in-out infinite 0.6s' }}
                >
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                {/* B2B Payments */}
                <div className="bg-white border border-[#e5e7eb] rounded-2xl p-8 hover:border-[#3b82f6]/30 hover:shadow-lg transition-all duration-300 min-h-[280px] flex flex-col">
                ...
                {/* Personal Remittance */}
                <div className="bg-white border border-[#e5e7eb] rounded-2xl p-8 hover:border-[#ed1c24]/30 hover:shadow-lg transition-all duration-300 min-h-[280px] flex flex-col">
                  <div className="w-16 h-16 bg-[#ed1c24]/10 rounded-xl flex items-center justify-center mb-6">
                ...
                {/* Easy Loan */}
                <div className="bg-white border border-[#e5e7eb] rounded-2xl p-8 hover:border-[#f59e0b]/30 hover:shadow-lg transition-all duration-300 min-h-[280px] flex flex-col">
                ...
                {/* GME Card */}
                <div className="bg-white border border-[#e5e7eb] rounded-2xl p-8 hover:border-[#1f2937]/30 hover:shadow-lg transition-all duration-300 min-h-[280px] flex flex-col">
                  <div className="w-16 h-16 bg-[#1f2937]/10 rounded-xl flex items-center justify-center mb-6">
              ...
              <div className="flex items-center gap-3 mb-5 mt-12">
                ...
                <h2 className="text-xl font-semibold text-[#666]">Related Services</h2>
              </div>

              {/* Second Row - 4 Related Services (Smaller & Subtle) */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Digital Wallet */}
                <div className="bg-[#fafafa] rounded-xl p-6 hover:bg-white hover:shadow-md transition-all duration-300">
