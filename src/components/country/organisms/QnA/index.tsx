const QnA = () => {
  return (
    <section id="QnA" className="max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-10 py-12 sm:py-16 lg:py-24">
      ...
      <div id="QnA-1" className="py-7 px-5 border-b border-[#e0e0e0]">
        <h2 className="text-[17px] font-semibold text-[#181818]">How long does it take to send money with GME Remit?</h2>
      ...
      <div id="QnA-2" className="py-7 px-5 border-b border-[#e0e0e0]">
        <h2 className="text-[17px] font-semibold text-[#181818]">Is GME Remit safe to use?</h2>
      ...
      <div id="QnA-3" className="py-7 px-5 border-b border-[#e0e0e0]">
      <h2 className="text-[17px] font-semibold text-[#181818]">How do I sign up for a GME Remit account?</h2>
      ...
      <div id="QnA-4" className="py-7 px-5 border-b border-[#e0e0e0]">
      <h2 className="text-[17px] font-semibold text-[#181818]">Which countries can I send money to with GME Remit?</h2>
      ...
      <div id="QnA-5" className="py-7 px-5 border-b border-[#e0e0e0]">
        <h2 className="text-[17px] font-semibold text-[#181818]">What if I have a problem with my transfer?</h2>
