      ...
      <div className="space-y-8 text-gray-600">
        ...
        <div>
          ...
          <div className="mt-3 space-y-3">
            ...
            <p>3. 재화 또는 서비스 제공 회사의 소액해외송금 서비스, 선불카드 서비스 제공 시 이와 관련된 본인인증, 상담 또는 새로운 상거래 신청 시 본인 여부 확인</p>
        ...
        {/* Article 2 */}
        <div>
          <h3 className="text-lg font-semibold text-dark">제2조(수집하는 개인정보의 항목 및 수집방법)</h3>
          <div className="mt-3 space-y-3">
            ...
            <p>5. 보험 보장서비스가 부가된 카드 상품</p>
            <p>[필수] 보험금 수령 가족 구성원(수익자) 정보(성명, 신청인과의 관계, 생년월일, 연락처)</p>
            <p>② 수집방법</p>
        ...
        <div>
            ...
            <table className="min-w-full border border-gray-300 text-sm">
              ...
              <tbody>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="border border-gray-300 px-4 py-3" rowSpan={2}>이용자 식별정보, 계약/청약철회 기록 등</td>
                  <td className="border border-gray-300 px-4 py-3" rowSpan={2}>5년</td>
                </tr>
                <tr className="!bg-white">
                ...
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-4 py-3">특정 금융거래정보의 보고 및 이용 등에 관한 법률</td>
                  <td className="border border-gray-300 px-4 py-3">금융거래등을 이용한 자금세탁행위 및 공중협박자금조달행위 방지</td>
                  <td className="border border-gray-300 px-4 py-3">자금의 원천, 출처 및 고객 정보에 관한 기록</td>
                  <td className="border border-gray-300 px-4 py-3">5년(탈퇴시점으로부터)</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="mt-6 space-y-3">
            <p>2. 회사는 이용자의 관계 법령 위반에 따른 수사ㆍ조사 등이 진행 중인 경우에는 해당 수사ㆍ조사 종료 시까지, 이용자의 서비스 이용에 따른 채권ㆍ채무관계 잔존시에는 해당 채권ㆍ채무관계 정산 시까지 이용자 개인정보를 보유합니다.</p>
            <p>3. 회사는 1년 동안 회사의 서비스를 이용하지 않은 이용자의 개인정보는 내부 방침에 따라 이용자에게 사전통지하고 개인정보를 파기하거나 별도로 분리하여 저장 관리합니다.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-3 space-y-4">
            ...
            <div>
              ...
              <p>– 제공받는 자의 보유•이용기간: 외국환거래법 등 관계 법령에서 정한 기간</p>
            </div>
            ...
            <div>
              ...
              <p>– 제공받는 자의 보유•이용기간: 전자금융거래법에 따라 5년</p>
            </div>
            ...
            <div>
              ...
              <p>– 제공받는 개인정보 항목: 송금인 관련정보(금융기관명, 성명, 계좌번호, 주소, 실명번호, 송금금액, 송금일자, 휴대폰 번호), 수취인 관련정보(수취금융기관명, 성명, 계좌번호, 전화번호)</p>
              <p>– 제공받는 자의 보유•이용기간: 해당국 관계 법령에서 정한 기간</p>
            </div>
            <div className="mt-6 space-y-4">
              ...
              <div>
                ...
                <p>– 제공받는 자의 개인정보 이용목적 : GME REMIT 앱 내 “KTX 결합상품 예약서비스” 제공 용도, 및 선불카드 발급·관리, 결제 승인·정산·청구, 부정사용 방지 및 민원 처리</p>
                <p>– 제공받는 개인정보 항목: 성명, 생년월일, 휴대전화번호, 성별, 국적, 카드번호 및 카드 이용정보(승인·결제 내역)</p>
                <p>– 제공받는 자의 보유•이용기간: 제3조와 같음</p>
              </div>
              ...
              <div>
                <p className="font-medium text-dark">11. 보험회사 (카드 상품 부가 단체보험 보장서비스)</p>
                <p>– 개인정보를 제공받는 자: DB손해보험㈜</p>
                <p>– 제공받는 자의 개인정보 이용목적: 회사를 보험계약자, 카드회원을 피보험자로 하는 단체보험의 가입·유지·관리, 보험사고 접수, 보험금 지급 심사 및 지급</p>
                <p>– 제공받는 개인정보 항목: 성명, 생년월일, 성별, 국적, 휴대폰 번호, 카드 발급일 및 해지일, 회원 자격 유지기간, 보험금 지급조건 확인에 필요한 카드 이용 실적, 보험금 수령 가족 구성원(수익자) 정보(성명, 피보험자와의 관계, 생년월일, 연락처)</p>
                <p>– 제공받는 자의 보유•이용기간: 피보험자 자격 상실(카드 해지 또는 회원 탈퇴 포함) 또는 보험계약 종료 후 3년(상법상 보험금청구권 소멸시효)까지. 단, 보험업법 등 관계 법령에서 별도의 보존기간을 정한 경우 그 기간까지</p>
                <p>※ 보험금 청구 과정에서 필요한 건강에 관한 정보(진단서, 치료 내역 등 민감정보)는 본 방침에 따라 수집·제공되지 않으며, 보험금 청구 접수 시 「개인정보 보호법」 제23조에 따라 별도의 동의를 받습니다.</p>
              </div>

              <div>
                <p className="font-medium text-dark">12. 고객의 동의 거부</p>
        ...
        <div>
          ...
          <div className="mt-3 space-y-2">
            ...
            <Link target="_blank" href="/privacy/cross-border-transfer-list" className="underline underline-offset-4 pb-3">* 개인정보 국외 제공 업체 목록</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-3 space-y-3">
            <p>① 이용자(만 14세 미만인 경우에는 법정대리인)는 회사에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.<br/>
            1. 개인정보 열람 요구<br/>
            2. 개인정보 전송 요구<br/>
            3. 정정·삭제 요구<br/>
            4. 처리정지 요구<br/>
            5. 동의 철회<br/>
            6. 자동화된 결정에 대한 거부 및 설명 요구</p>
            <p>② 제1항에 따른 권리 행사는 회사에 대해 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 (주)글로벌머니익스프레스는 이에 대해 지체 없이 조치하겠습니다.</p>
        ...
        <div>
          ...
          <div className="mt-3 space-y-3">
            ...
            <p>② 이용자로부터 동의 받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 보존하는 경우 별도 분리하여 보관하며, 보존근거와 보존항목은 다음과 같습니다.<br/>
              [법령에 따른 보존현황]<br/>
        ...
        <div>
          ...
          <div className="mt-3 space-y-3">
            ...
            <p>5. 해킹 등에 대비한 기술적 대책<br/>회사는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신•점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.</p>
            <p>6. 개인정보에 대한 접근 제한<br/>개인정보를 처리하는 데이터베이스시스템에 대한 접근권한의 부여, 변경, 말소를 통하여 개인정보에 대한 접근통제를 위하여 필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단접근을 통제하고 있습니다.</p>
            <p>7. 접속기록의 보관 및 위변조 방지<br/>개인정보처리시스템에 접속한 기록을 최소 6개월 이상 보관, 관리하고 있으며, 접속 기록이 위변조 및 도난, 분실되지 않도록 보안기능을 사용하고 있습니다.</p>
        ...
        <div>
          ...
          <div className="mt-3 space-y-3">
            <p>1) 고객상담센터의 운영<br/>
            회사는 고객님과의 원활한 의사소통을 위해 고객상담센터를 운영하고 있습니다.<br/>
            [고객상담센터 ] / 1811-2961</p>

            <p>2) 링크사이트<br/>
            회사는 고객님께 다른 회사의 웹사이트 또는 자료에 대한 링크를 제공할 수 있습니다. 이 경우 회사는 외부사이트 및 자료에 대한 아무런 통제권이 없으므로 그로부터 제공받는 서비스나 자료의 유용성에 대해 책임질 수 없으며 보증할 수 없습니다. 회사가 포함하고 있는 링크를 클릭하여 타 사이트의 페이지로 옮겨갈 경우 해당 사이트의 개인정보 보호정책은 회사와 무관하므로 새로 방문한 사이트의 정책을 확인하시기 바랍니다.</p>

            <p>3) 광고성 정보 전송<br/>
            회사는 고객님의 명시적인 수신거부 의사에 반하여 영리목적의 광고성 정보를 전송하지 않습니다. 회사는 고객님이 뉴스레터 등 전자우편 전송에 대한 동의를 한 경우와 상품정보 안내의 온라인 마케팅을 위해 광고성 정보를 전자우편 등으로 전송하는 경우 전자우편의 제목란 및 본 문란에 고객님이 쉽게 알아 볼 수 있도록 조치합니다. 팩스, 휴대폰 문자전송 등 전자우편 이외의 문자전송을 통해 영리목적의 광고성 정보를 전송하는 경우에는 전송내용 처음에 “(광고)” 라는 문구를 표시하고 전송내용 중에 전송자의 연락처를 명시하도록 조치합니다.</p>
          </div>
        </div>
