      ...
      <div className="prose prose-gray max-w-none">
        ...
        <div className="mb-10 p-6 bg-gray-50 rounded-lg space-y-4">
          <p className="text-gray-600 leading-relaxed">
            ㈜글로벌머니익스프레스(이하 회사)는 회원의 개인정보 보호를 위하여 『개인정보 보호법』, 『전자금융거래법』, 『특정 금융거래정보의 보고 및 이용 등에 관한 법률』 등 개인정보 보호 관련 법령을 준수하고 있으며 이를 위하여 회사 개인정보 처리방침(이하 개인정보 처리방침)을 제정하고 이를 준수하고 있습니다.회사는 개인정보 처리방침을 회사 홈페이지 및 GME Remit 어플리케이션 내 별도 메뉴를 통하여 상시 공개함으로써 고객께서 언제나 용이하게 보실 수 있도록 조치하고 있습니다.개인정보 처리방침은 관련법령, 지침 및 회사 내부 방침의 변경, 그 밖의 합리적인 사유에 따라 변경될 수 있으며 변경 시 관련법령이 정하는 절차에 따라 변경 이유와 변경내용을 공지하도록 하겠습니다.
          </p>  
          <p className="text-gray-600 leading-relaxed">
